...
namespace fb2019
{
	...
	public:
		...
		{
		public:
			ea_t m_pActionFunction1_ppResult; //0x0038
			ea_t _0x0030; //0x0030
			ea_t m_pActionFunction2; //0x0038
			ea_t m_pActionFunction3_pResult; //0x0040
			ea_t _0x0048; //0x0048
			Util::MemoryArrayPointer<ActionParamData> m_pFields; //0x0028 ActionFieldData*
		};
