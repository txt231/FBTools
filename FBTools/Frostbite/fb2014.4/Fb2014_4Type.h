...
namespace Frostbite
{
	namespace Fb2014_4
	{
		...
		{
		public:
			Fb2014_4Type( ea_t typeInfo, ea_t typeData = BADADDR )
			{
				...
				Util::MemoryPointer<fb2014_4::TypeInfo::TypeInfoData> TypeDataRef( TypeData );

				fb2014_4::TypeInfo::TypeInfoData* pData = TypeDataRef;
			...
			virtual bool GetName( std::string& outString ) override
			{
				...
				Util::MemoryPointer<fb2014_4::TypeInfo::TypeInfoData> TypeDataRef( m_TypeData );
			...
			static Fb2014_4Type* CreateFromTypeInfo( ea_t typeInfo )
			{
				if ( typeInfo == 0 ||
					 typeInfo == BADADDR )
					return nullptr;

				return new Fb2014_4Type( typeInfo );
			}

			static Fb2014_4Type* CreateFromTypeInfoData( ea_t typeInfoData )
			{
				if ( typeInfoData == 0 ||
					 typeInfoData == BADADDR )
					return nullptr;

				return new Fb2014_4Type( BADADDR, typeInfoData );
			}
		};
	}
}