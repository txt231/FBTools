...
#include "../../Sdk/fb2017/FieldInfo.h"
...
namespace Frostbite
{
	namespace Fb2017
	{
		class Fb2017FieldType
			: public IFbField
		{
		public:
			Fb2017FieldType( ea_t typeInfo, ea_t typeData = BADADDR )
			{
				...
				Util::MemoryPointer<fb2017::FieldInfo::FieldInfoData> TypeDataRef( TypeData );
